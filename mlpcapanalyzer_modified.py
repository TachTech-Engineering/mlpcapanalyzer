...
from scapy.all import PcapReader, TCP, UDP, IP, DNS, Raw
    ...
    try:
        ...
        with open(filepath, 'w') as f:
            ...
            try:
                ...
                # Loop through each packet using PcapReader for memory efficiency
                ...
                log(f"**Total IP packets analyzed: {total_ip_packet_count} (out of {total_packets} total packets)**")
                log("="*60)
                log("\n```") # Start code block
